...
- [ ] Confirm Query Logs, Evaluation Cases, Retrieval Evaluation, and Quality Issues are read-only evidence surfaces, while Conflicts, Expired Knowledge, Duplicates, Admin, Parser/Storage/System routes remain visual skeletons or deferred surfaces.
