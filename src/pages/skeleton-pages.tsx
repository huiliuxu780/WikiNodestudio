...
export function IndexSegmentListPage() {
  return (
    <PageScaffold
      ...
      description="Index Segments are controlled retrieval units generated from WikiNodes before vector-store sync. They are not internal chunks generated by external vector databases."
    >
      <IndexSegmentTable segments={mockIndexSegments.slice(0, 30)} />
    </PageScaffold>
  )
}
...
export function SegmentStrategyPage() {
  return (
    <PageScaffold title="Segment Strategy" description="Configure mock rules for WikiNode-to-Index Segment generation.">
      <SegmentStrategyCard />
    </PageScaffold>
  )
}
