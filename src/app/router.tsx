...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: "/conflicts", element: <GenericSkeletonPage title="冲突检测" /> },
      { path: "/expired-knowledge", element: <GenericSkeletonPage title="过期知识" /> },
      { path: "/duplicates", element: <GenericSkeletonPage title="重复知识" /> },
