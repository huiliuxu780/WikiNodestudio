...
const sources = [
  ...
  },
  {
    ...
    credentialOwner: "产品培训",
    lastCredentialCheckedAt: "2026-06-18 15:10",
    connectionStatus: "available",
    syncPolicy: "manual",
  ...
  },
  {
    ...
    credentialScope: "收费标准文件读权限",
    credentialOwner: "服务财务",
    lastCredentialCheckedAt: "2026-06-16 09:00",
  ...
  },
  {
    ...
    owner: "产品资料",
    ingestionMode: "manual_import",
    credentialProfile: "word-manual-readonly",
    credentialStatus: "expired",
    credentialScope: "产品资料库只读",
    credentialOwner: "产品资料",
    lastCredentialCheckedAt: "2026-06-15 18:10",
...
const sourceOperations = [
  {
    operationId: "op-src-feishu-credential-001",
    ...
    status: "succeeded",
    requestedBy: "system",
    startedAt: "2026-06-20T10:25:00+08:00",
    finishedAt: "2026-06-20T10:25:20+08:00",
    summary: "Credential profile feishu-after-sales-space passed readiness check.",
    errorSummary: null,
  },
  {
